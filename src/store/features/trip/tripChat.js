...
export const { sendFailed, sendRequest, sendSuccess } = getTripChat.actions;
...
export const fetchTripChat = (tripId) => (dispatch) => {
	dispatch(requestSend());
	const call = {
		url: baseUrl + `messages/${tripId}`,
		method: "GET",
		headers: {
...
export default getTripChat.reducer;
